...
-- Uncomment the following tests as you complete the exercises
 ...
 expect(q.c == -100.0)
 expect(q.d == -1.25)
 self = Quaternion.new(1.0, 3.0, 5.0, 2.0);
 other = Quaternion.new(-2.0, 2.0, 8.0, -1.0);
 ...
 expect_array_equals(other:coefficients(), { -2.0, 2.0, 8.0, -1.0})
 expect(self + other == q3)
 expect(self * other == q4)
 expect(self + zero == self)
 expect(self * zero == zero)
 expect(i * j == k)
 expect(j * k == i)
